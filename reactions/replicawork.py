...
class ReplicaWorkChain(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.outline(
            ...
            while_(cls.next_replica)(
                ...
                while_(cls.not_converged)(cls.generate_replica),
                cls.store_replica,
            ),
        )
    ...
    def generate_replica(self):
        ...
        self.report(
            "Running CP2K geometry optimization - Target: {}".format(
    ...
    def store_replica(self):
        ...
        if not self.ctx.init_geo_stored:
            ...
            initial_params = Dict(
                dict={
                    "energy_scf": self.ctx.initial_scf.outputs["output_parameters"][
                        "energy_scf"
                    ],
                    "energy_force": self.ctx.initial_scf.outputs["output_parameters"][
                        "energy"
                    ],
                }
            )
        ...
        params = Dict(
            dict={
                "energy_scf": self.ctx.replica.outputs["output_parameters"][
                    "energy_scf"
                ],
    ...
    def build_calc_inputs(
        ...
        if initial_energy:
            ...
            inputs["metadata"]["description"] = "replica_{}_{}".format(
                calc_name, colvar_target
            )
